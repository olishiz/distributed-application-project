...
public class audio1 {
    ...
    private int sendPort = 8080; // The port number to which the agent wishes to send
    private int receivePort = 9090; // The agent's own port number, to listen on for traffic
            ...
            try {
                ...
                try{
                    ...
                    while(!stopCapture){
                        ...
                        if(cnt > 0){
                            DatagramPacket outPacket = new DatagramPacket(tempBuffer, tempBuffer.length,
                                this.ip, this.port);
